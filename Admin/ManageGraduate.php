...
<body style="background-image: url('123.jpeg');">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="27" bgcolor="#A0B9F3"><strong>Create Graduate</strong></td>
        </tr>
        <tr>
          <td height="26"><form method="post" action="InsertGraduate.php">
        ...
        <tr>
          <td height="25" bgcolor="#A0B9F3"><strong>Graduates List</strong></td>
        </tr>
        <tr>
          <td>
...
<th bgcolor="#1CB5F1"><div align="left" class="style9 style5"><strong>Edit</strong></div></th>
...
<td><div align="left" class="style9 style5"><strong><a href="EditGraduate.php?UserId=<?php echo $Id;?>">Edit</a></strong></div></td>
<td><div align="left" class="style9 style5"><strong><a href="DeleteGraduate.php?UserId=<?php echo $Id;?>">Delete</a></strong></div></td>
</tr>
<?php
}
...
?>
<tr>
<td colspan="4" style="color:white;" class="style3"><div align="left" class="style12"><?php echo "Total ".$records." Records"; ?> </div></td>
</tr>
<?php
