...
<html lang="en-CA" class="language" style="margin-top:0px !important">
...
<a class="btn" a href="index.php" id="back">Back Home</a>
<form action="GraduateInsert.php" method="post" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data">
               <h2><span><div align="center">GRADUATE Sign Up Form</div></span></h2>
<div class = "input-group">
                  <span class="input-group-addon"id="basic-addon1">Email</span>
<input type="text" name="txtEmail" class="form-control" placeholder="xyz@gmail.com" required>
                  <p></p>
...
<p></p>
<button class="btn" input type="submit" name="button2">Sign Up</button>
<p></p>
<a class="btn" a href="signup.html"><a href="signin.php">Already have an account? Sign In</a>
</form>
